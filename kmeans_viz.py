...
def draw_assignment(centroids, data, assignment, colors): ""! Function draw_assignment Input: centroids (a list of lists), data (a list of lists), assignment (a list of lists, organized by index), and a list of colors (strings). Returns: Nothing Does: Uses the nested list assignment to find the indices of each data point in data, and its corresponding centroid in centroids. Once the correct point is found, we draw it using the corresponding centroid's color.
